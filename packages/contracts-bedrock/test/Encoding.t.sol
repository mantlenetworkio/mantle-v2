...
contract Encoding_Test is CommonTest {
        ...
        external
    {
        ...
        bytes memory encoding =
            Encoding.encodeCrossDomainMessage(nonce, _sender, _target, _mntValue, _ethValue, _gasLimit, _data);

        bytes memory _encoding =
            ffi.encodeCrossDomainMessage(nonce, _sender, _target, _mntValue, _ethValue, _gasLimit, _data);
