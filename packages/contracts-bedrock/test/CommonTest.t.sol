...
import { LegacyERC20MNT } from "src/legacy/LegacyERC20MNT.sol";
...
contract Messenger_Initializer is Portal_Initializer {
    ...
    function setUp() public virtual override {
        ...
        ResolvedDelegateProxy proxy = new ResolvedDelegateProxy(addressManager, "BVM_L1CrossDomainMessenger");
...
contract Bridge_Initializer is Messenger_Initializer {
    ...
    function setUp() public virtual override {
        ...
        OptimismMintableERC20Factory factory = new OptimismMintableERC20Factory(Predeploys.L2_STANDARD_BRIDGE);
