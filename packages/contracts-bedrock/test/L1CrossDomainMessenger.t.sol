...
contract L1CrossDomainMessenger_Test is Messenger_Initializer {
    ...
    function test_relayMessage_with_mnt_value_succeeds() external {
        ...
        bytes32 hash = Hashing.hashCrossDomainMessage(
            Encoding.encodeVersionedNonce({ _nonce: 0, _version: 1 }), sender, target, 100, 0, 0, hex"1111"
        );
    ...
    function test_relayMessage_succeeds() external {
        ...
        bytes32 hash = Hashing.hashCrossDomainMessage(
            Encoding.encodeVersionedNonce({ _nonce: 0, _version: 1 }), sender, target, 0, 0, 0, hex"1111"
        );
    ...
    function test_relayMessage_toSystemContract_reverts() external {
        ...
        L1Messenger.relayMessage(
            Encoding.encodeVersionedNonce({ _nonce: 0, _version: 1 }), sender, target, 0, 0, 0, message
        );
    ...
    function test_xDomainMessageSender_reset_succeeds() external {
        ...
        vm.prank(address(op));
        L1Messenger.relayMessage(
            Encoding.encodeVersionedNonce({ _nonce: 0, _version: 1 }), address(0), address(0), 0, 0, 0, hex""
        );
    ...
    function test_relayMessage_retryAfterFailure_succeeds() external {
        ...
        bytes32 hash = Hashing.hashCrossDomainMessage(
            Encoding.encodeVersionedNonce({ _nonce: 0, _version: 1 }), sender, target, 0, value, 0, hex"1111"
        );
