 ...
 */
abstract contract BaseL2StandardBridge {
     ...
     */
    BaseL1StandardBridge public immutable OTHER_BRIDGE;
    ...
    constructor(address payable _messenger, address payable _otherBridge) {
        ...
        OTHER_BRIDGE = BaseL1StandardBridge(_otherBridge);
    }
     ...
     *         BaseL2StandardBridge.sol on the other chain until the call is replayed. If the call cannot be
     *         replayed with any amount of gas (call always reverts), then the ETH will be
     *         permanently locked in the BaseL2StandardBridge.sol on the other chain. ETH will also
    ...
    function _initiateBridgeETH(
        ...
        MESSENGER.sendMessage{ value: _amount }(
            ...
            abi.encodeWithSelector(
                BaseL1StandardBridge.finalizeBridgeETH.selector,
                _from,
                _to,
                _amount,
                _extraData
    ...
    function _initiateBridgeERC20(
        ...
        MESSENGER.sendMessage(
            address(OTHER_BRIDGE),
            abi.encodeWithSelector(
                BaseL1StandardBridge.finalizeBridgeERC20.selector,
