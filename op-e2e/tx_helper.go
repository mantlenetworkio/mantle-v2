...
func SendDepositTx(t *testing.T, cfg SystemConfig, l1Client *ethclient.Client, l2Client *ethclient.Client, l1Opts *bind.TransactOpts, applyL2Opts DepositTxOptsFn) {
	...
	// Finally send TX
	tx, err := depositContract.DepositTransaction(l1Opts, l2Opts.ETHValue, l2Opts.MNTValue, l2Opts.ToAddr, l2Opts.MNTValue, l2Opts.GasLimit, l2Opts.IsCreation, l2Opts.Data)
