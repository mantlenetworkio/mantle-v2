...
// using Mantle-specific genesis and rollup config.
//
// Differences from opreth.NewRethEngine:
//   - Uses e2eutils.GetMantleL2AllocsMode instead of GetL2AllocsMode
//   - Uses genesis.BuildMantleGenesis instead of BuildL2Genesis
//   - Uses cfg.DeployConfig.MantleRollupConfig instead of RollupConfig
//
...
func NewRethEngine(t testing.TB, ctx context.Context, cfg *e2esys.SystemConfig) (*enginetest.OpEngine, error) {
	...
	// Note: Using CanyonTime here; for Mantle chains Shanghai is activated at the same time as Canyon.
