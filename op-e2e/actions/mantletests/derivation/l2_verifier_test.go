...
func TestL2Verifier_SequenceWindow(t *testing.T) {
	tests := []struct {
		name string
		f    func(gt *testing.T, forksname rollup.MantleForkName)
	}{
		{"L2Verifier_SequenceWindow", L2Verifier_SequenceWindow},
	}
...
func L2Verifier_SequenceWindow(gt *testing.T, forksname rollup.MantleForkName) {
