...
func SetupMantleSafeDBTest(t helpers.Testing, config *e2eutils.TestParams, forksname rollup.MantleForkName) (*e2eutils.SetupData, *helpers.L1Miner, *helpers.L2Sequencer, *helpers.L2Verifier, *helpers.L2Engine, *helpers.L2Batcher) {
