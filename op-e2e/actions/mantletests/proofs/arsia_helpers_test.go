...
type arsiaExpectations struct {
	preArsia, arsia expectations
}

func (h arsiaExpectations) RequireExpectedProgressAndLogs(t actionsHelpers.StatefulTesting, actualSafeHead eth.L2BlockRef, isArsia bool, engine *actionsHelpers.L2Engine, logs *testlog.CapturingHandler) {
	t.Helper()
