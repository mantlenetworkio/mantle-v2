...
GLOBAL OPTIONS:
   ...
   --operator-fee-constant-update-interval uint64     the interval of updating the operator fee constant (default: 86400) [$GAS_PRICE_ORACLE_OPERATOR_FEE_CONSTANT_UPDATE_INTERVAL]
   --operator-fee-scalar-update-interval uint64       the interval of updating the operator fee scalar [$GAS_PRICE_ORACLE_OPERATOR_FEE_SCALAR_UPDATE_INTERVAL]
