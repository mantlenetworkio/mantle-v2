...
func (m *MantleMinimal) L2Networks() []*dsl.L2Network {
	return []*dsl.L2Network{
		m.L2Chain,
	}
}

func (m *MantleMinimal) StandardBridge() *dsl.StandardBridge {
...
func (m *MantleMinimal) DisputeGameFactory() *proofs.DisputeGameFactory {
...
func (m *MantleMinimal) AdvanceTime(amount time.Duration) {
...
func NewMantleMinimal(t devtest.T) *MantleMinimal {
	system := shim.NewSystem(t)
	orch := Orchestrator()
	orch.Hydrate(system)

	return mantleMinimalFromSystem(t, system, orch)
}

func mantleMinimalFromSystem(t devtest.T, system stack.ExtensibleSystem, orch stack.Orchestrator) *MantleMinimal {
