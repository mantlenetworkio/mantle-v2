...
func TestGetBlob(t *testing.T) {
	...
	hashes := []eth.IndexedBlobHash{
		eth.IndexedBlobHash{
			Index: 19,
			Hash:  common.HexToHash("0x01f3bf5ea7a12c46885675c90566d89c1fca1c60a611005675a7e8a86dd3b359"),
		},
	}
	_, err := l1BeaconClient.GetBlobs(context.Background(), ref, hashes)
	if err != nil {
		panic(fmt.Errorf("failed to get blobs: %w", err))
	}
}
