...
// MantleL1StandardBridge matches Mantle's L1StandardBridge ABI, including MNT paths.
type MantleL1StandardBridge struct {
	// Read-only functions
	...
	DepositMNT               func(amount eth.ETH, minGasLimit uint32, extraData []byte) TypedCall[any]                                                                     `sol:"depositMNT"`
	DepositMNTTo             func(to common.Address, amount eth.ETH, minGasLimit uint32, extraData []byte) TypedCall[any]                                                  `sol:"depositMNTTo"`
	...
	FinalizeMantleWithdrawal func(from common.Address, to common.Address, amount eth.ETH, extraData []byte) TypedCall[any]                                                 `sol:"finalizeMantleWithdrawal"`
