...
require (
	...
	github.com/ethereum/go-ethereum/superchain v0.0.0-00010101000000-000000000000
...
replace github.com/ethereum/go-ethereum => github.com/mantlenetworkio/op-geth v1.4.0-rc0.0.20251111063855-85bb50b16b2a
