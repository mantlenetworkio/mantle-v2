...
import (
	...
	bnl "github.com/Layr-Labs/datalayr/lib/encoding/kzg/bn254"

	//gnark254 "github.com/consensys/gnark-crypto/ecc/bn254"
...
func Verify(commitment *gkzg.Digest, proof *gkzg.OpeningProof, point fr.Element, srs *gkzg.SRS) error {
	...
	fmt.Println(fminusfaG1Aff.String())

	fmt.Println("xminusaG2Aff")
	fmt.Println(xminusaG2Aff.String())

	fmt.Println("proof")
	fmt.Println(proof.H.String())
