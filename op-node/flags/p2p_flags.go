...
func p2pEnvs(v string) []string {
	return []string{prefixEnvVar("P2P_" + v)}
}
...
var (
	...
	ListenTCPPort = &cli.UintFlag{
		...
		Required: false,
		Value:    9222,
		EnvVars:  p2pEnvs("LISTEN_TCP_PORT"),
	}
	ListenUDPPort = &cli.UintFlag{
		...
		EnvVars:  p2pEnvs("LISTEN_UDP_PORT"),
	}
	...
	TimeoutNegotiation = &cli.DurationFlag{
		...
		EnvVars:  p2pEnvs("TIMEOUT_NEGOTIATION"),
	}
	TimeoutAccept = &cli.DurationFlag{
		...
		Required: false,
		Value:    10 * time.Second,
		EnvVars:  p2pEnvs("TIMEOUT_ACCEPT"),
	}
	...
	PeerstorePath = &cli.StringFlag{
		...
		EnvVars:   p2pEnvs("PEERSTORE_PATH"),
	}
	DiscoveryPath = &cli.StringFlag{
		...
		EnvVars:   p2pEnvs("DISCOVERY_PATH"),
	}
	...
	GossipMeshDloFlag = &cli.UintFlag{
		...
		EnvVars:  p2pEnvs("GOSSIP_MESH_DLO"),
	}
	GossipMeshDhiFlag = &cli.UintFlag{
		...
		EnvVars:  p2pEnvs("GOSSIP_MESH_DHI"),
	}
	GossipMeshDlazyFlag = &cli.UintFlag{
		...
		EnvVars:  p2pEnvs("GOSSIP_MESH_DLAZY"),
	}
	GossipFloodPublishFlag = &cli.BoolFlag{
		...
		Required: false,
		Hidden:   true,
		EnvVars:  p2pEnvs("GOSSIP_FLOOD_PUBLISH"),
	}
