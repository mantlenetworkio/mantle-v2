...
var (
	...
	// EIP-2935
	skadiBlockHashDeployerSource     = UpgradeDepositSource{Intent: "Skadi: EIP-2935 Contract Deployment"}
	skadiBlockHashDeploymentBytecode = common.FromHex("0x60538060095f395ff33373fffffffffffffffffffffffffffffffffffffffe14604657602036036042575f35600143038111604257611fff81430311604257611fff9006545f5260205ff35b5f5ffd5b5f35611fff60014303065500")
)
...
func MantleSkadiNetworkUpgradeTransactions() ([]hexutil.Bytes, error) {
	...
	deployHistoricalBlockHashesContract, err := types.NewTx(&types.DepositTx{
		SourceHash:          skadiBlockHashDeployerSource.SourceHash(),
		...
		Gas:                 250_000,
		IsSystemTransaction: false,
		Data:                skadiBlockHashDeploymentBytecode,
	}).MarshalBinary()
	if err != nil {
		return nil, err
	}
