...
func NewDriver(
	...
	derivationPipeline := derive.NewDerivationPipeline(log, cfg, verifConfDepth, l1Blobs, l2, daSyncer, metrics, syncCfg, safeHeadListener, eigenDaSyncer)
